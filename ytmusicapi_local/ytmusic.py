...
from ytmusicapi_local.helpers import (
    SUPPORTED_LANGUAGES,
    SUPPORTED_LOCATIONS,
    USER_AGENT,
    YTM_BASE_API,
...
from ytmusicapi_local.mixins.browsing import BrowsingMixin
from ytmusicapi_local.mixins.explore import ExploreMixin
from ytmusicapi_local.mixins.library import LibraryMixin
from ytmusicapi_local.mixins.playlists import PlaylistsMixin
from ytmusicapi_local.mixins.podcasts import PodcastsMixin
from ytmusicapi_local.mixins.search import SearchMixin
from ytmusicapi_local.mixins.uploads import UploadsMixin
from ytmusicapi_local.mixins.watch import WatchMixin
from ytmusicapi_local.parsers.i18n import Parser

from ytmusicapi_local.auth.oauth import OAuthCredentials, OAuthToken, RefreshingToken
from ytmusicapi_local.auth.oauth.token import Token
from ytmusicapi_local.auth.types import AuthType
...
class YTMusicBase:
    def __init__(
        ...
        try:
            ...
            print('Error en los archivos de traducción')

            ruta_actual = os.getcwd() + os.sep + "locales"
            print(f"gettext.translation('base', localedir={ruta_actual}, languages={[language]}")
            self.lang = gettext.translation("base", localedir=ruta_actual, languages=[language])
