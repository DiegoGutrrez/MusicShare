...
from ytmusicapi_local.auth.oauth.credentials import Credentials
from ytmusicapi_local.auth.oauth.models import BaseTokenDict, Bearer, DefaultScope, RefreshableTokenDict
...
class RefreshingToken(OAuthToken):
    ...
    def prompt_for_token(
        ...
        input(f'\nVaya a {url}, finalice el proceso de inicio de sesión y pulse ENTER cuando acabe')
